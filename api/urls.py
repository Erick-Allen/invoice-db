...
from .views import (
    ...
    SupplierLocationListCreateView,
    SupplierLocationDetailView,
...
urlpatterns = [
    ...
    path("customers/<int:customer_id>/locations/", CustomerLocationListCreateView.as_view(), name="customer-location-list-create"),
    path("customers/<int:customer_id>/locations/<int:location_id>/", CustomerLocationDetailView.as_view(), name="customer-location-detail"),
    ...
    path("product-categories/<int:category_id>/detail/", ProductCategoryOverviewView.as_view(), name="product-category-overview"),
    ...
    path("suppliers/<int:supplier_id>/locations/", SupplierLocationListCreateView.as_view(), name="supplier-location-list-create"),
    path("suppliers/<int:supplier_id>/locations/<int:location_id>/", SupplierLocationDetailView.as_view(), name="supplier-location-detail"),
    ...
    path("tags/<int:tag_id>/detail/", TagOverviewView.as_view(), name="tag-overview"),
